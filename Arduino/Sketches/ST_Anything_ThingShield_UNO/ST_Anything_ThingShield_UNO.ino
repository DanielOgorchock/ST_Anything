...
void setup()
{
  ...
  //Interrupt Sensors 
  static st::IS_Contact sensor1(F("contact1"), PIN_CONTACT1, LOW, true);
  static st::IS_Contact sensor2(F("contact2"), PIN_CONTACT2, LOW, true);
  static st::IS_Contact sensor3(F("contact3"), PIN_CONTACT3, LOW, true);
  static st::IS_Contact sensor4(F("contact4"), PIN_CONTACT4, LOW, true);
  static st::IS_Motion  sensor5(F("motion1"), PIN_MOTION1, LOW, true);
