//******************************************************************************************
//  File: ST_Anything_LatchingRelaySwitch_ESP8266WiFi.ino
...
//              - 1 x Latching Relay Switch device using two timed digital outputs and one digital input
//    
//  Change History:
//
//    Date        Who            What
...
#include <IS_LatchingRelaySwitch.h> //Implements special switch device with two digital output pins with timing capabilities and one digital input
...
//******************************************************************************************
#define PIN_INPUT           D5  //Digital Input to indicate status of the Latching Relay 
#define PIN_RELAY1          D6  //Timed Relay Output #1
#define PIN_RELAY2          D7  //Timed Relay Output #2
