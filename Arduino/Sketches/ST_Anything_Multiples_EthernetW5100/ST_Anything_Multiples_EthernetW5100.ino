...
//Analog Pins
#define PIN_WATER_1               A0  //SmartThings Capabilty "Water Sensor"
#define PIN_WATER_2               A1  //SmartThings Capabilty "Water Sensor"
#define PIN_ILLUMINANCE_1         A2  //SmartThings Capabilty "Illuminance Measurement"
#define PIN_ILLUMINANCE_2         A3  //SmartThings Capabilty "Illuminance Measurement"

//Digital Pins
#define PIN_TEMPERATUREHUMIDITY_1 22  //SmartThings Capabilties "Temperature Measurement" and "Relative Humidity Measurement"
#define PIN_TEMPERATUREHUMIDITY_2 23  //SmartThings Capabilties "Temperature Measurement" and "Relative Humidity Measurement"
#define PIN_MOTION_1              24  //SmartThings Capabilty "Motion Sensor"
#define PIN_MOTION_2              25  //SmartThings Capabilty "Motion Sensor"
#define PIN_CONTACT_1             26  //SmartThings Capabilty "Contact Sensor"
#define PIN_CONTACT_2             27  //SmartThings Capabilty "Contact Sensor"
#define PIN_SWITCH_1              28  //SmartThings Capabilty "Switch"
#define PIN_SWITCH_2              29  //SmartThings Capabilty "Switch"
#define PIN_TIMEDRELAY_1          30  //SmartThings Capabilty "Relay Switch"
#define PIN_TIMEDRELAY_2          31  //SmartThings Capabilty "Relay Switch"
#define PIN_SMOKE_1               32  //SmartThings Capabilty "Smoke Detector"
#define PIN_SMOKE_2               33  //SmartThings Capabilty "Smoke Detector"
#define PIN_ALARM                 34  //SmartThings Capabilty "Alarm"
...
void setup()
{
  ...
  static st::PS_Illuminance         sensor3(F("illuminance1"), 60, 20, PIN_ILLUMINANCE_1, 0, 1024, 0, 1000);
  static st::PS_Illuminance         sensor4(F("illuminance2"), 60, 30, PIN_ILLUMINANCE_2, 0, 1024, 0, 1000);
  ...
  static st::IS_Motion              sensor8(F("motion2"), PIN_MOTION_2, HIGH, false, 500);
  static st::IS_Contact             sensor9(F("contact1"), PIN_CONTACT_1, LOW, true, 500);
  static st::IS_Contact             sensor10(F("contact2"), PIN_CONTACT_2, LOW, true, 500);
  static st::IS_Smoke               sensor11(F("smoke1"), PIN_SMOKE_1, HIGH, true, 500);
  static st::IS_Smoke               sensor12(F("smoke2"), PIN_SMOKE_2, HIGH, true, 500);
  static st::IS_DoorControl         sensor13(F("doorControl1"), PIN_DOORCONTROL_CONTACT_1, LOW, true, PIN_DOORCONTROL_RELAY_1, LOW, true, 1000);
  static st::IS_DoorControl         sensor14(F("doorControl2"), PIN_DOORCONTROL_CONTACT_2, LOW, true, PIN_DOORCONTROL_RELAY_2, LOW, true, 1000);
  static st::IS_Button              sensor15(F("button1"), PIN_BUTTON1, 1000, LOW, true, 500);
  static st::IS_Button              sensor16(F("button2"), PIN_BUTTON2, 1000, LOW, true, 500);

  //Special sensors/executors (uses portions of both polling and executor classes)
  static st::S_TimedRelay           sensor17(F("relaySwitch1"), PIN_TIMEDRELAY_1, LOW, true, 3000, 0, 1);
  static st::S_TimedRelay           sensor18(F("relaySwitch2"), PIN_TIMEDRELAY_2, LOW, true, 3000, 0, 1);
  ...
  static st::EX_Alarm               executor3(F("alarm1"), PIN_ALARM, LOW, true);
