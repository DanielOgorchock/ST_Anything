//******************************************************************************************
//  File: ST_Anything_Multiples_NANO33IoT.ino
...
#define PIN_ALARM_1               11 //SmartThings Capability "Alarm"
#define PIN_ALARM_2               12 //SmartThings Capability "Alarm"
#define PIN_STROBE_2              13 //SmartThings Capability "Alarm"              
...
//Polling Sensors 
  ...
  static st::S_TimedRelay           sensor14(F("relaySwitch1"), PIN_TIMEDRELAY_1, LOW, true, 3000, 0, 1); //Inverted logic for "Active Low" Relay Board
  static st::S_TimedRelay           sensor15(F("relaySwitch2"), PIN_TIMEDRELAY_2, LOW, true, 3000, 0, 1); //Inverted logic for "Active Low" Relay Board
