...
#include <EX_RGBW_NeoPixelBus.h>      //Implements an Executor (EX) for a RGBW LED strip using the NeoPixelBus library.  If you are only 
...
void setup()
{
  ...
  //Executors
  static st::EX_RGBW_NeoPixelBus         executor1(F("rgbSwitch1"), 60, PIN_RGB1);  
