//******************************************************************************************
//  File: ST_Anything_NeoPixelBus_ESP8266WiFi.ino
...
//
//            ST_Anything_NeoPixelBus_ESP38266iFi implements the following ST Capabilities as a demo of what is possible with a NodeMCU ESP8266
...
//******************************************************************************************
#define PIN_RGB         D7  //SmartThings Capabilty "Color Control"
...
void setup()
{
  ...
  //Executors
  static st::EX_RGB_NeoPixelBus_T<NeoRgbFeature, NeoEsp8266Dma800KbpsMethod> executor1(F("rgbSwitch1"), 12, PIN_RGB);
