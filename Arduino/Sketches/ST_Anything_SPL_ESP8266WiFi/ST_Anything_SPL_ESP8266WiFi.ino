...
//
//            ST_Anything_SPL implements the following ST Capabilities as a demo of what is possible with a single NodeMCU ESP8266
...
#include <PS_SoundPressureLevel.h> //Implements a Polling Sensor (PS) to measure Sound Pressure Level via analog input
...
//******************************************************************************************
#define PIN_SPL               A0  //NodeMCU ESP8266 only has one Analog Input Pin 'A0'
...
void setup()
{
  ...
  //******************************************************************************************
  //Polling Sensors
    static st::PS_SoundPressureLevel sensor1(F("soundPressureLevel1"), 30, 0, PIN_SPL, 0, 1024, 0.0, 165.0, 50);
