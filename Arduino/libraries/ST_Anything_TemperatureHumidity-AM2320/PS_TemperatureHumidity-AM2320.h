//******************************************************************************************
//  File: PS_TemperatureHumidity-AM2320.h
...
namespace st
{
	class PS_TemperatureHumidity_AM2320: public PollingSensor
	{
		private:
			...
			static DHT_AM2320 DHT(uint8_t pin, uint8_t type, uint8_t count=6);					//DHT library object
		...
		public:
			...
			PS_TemperatureHumidity_AM2320(const __FlashStringHelper *name, unsigned int interval, int offset, byte digitalInputPin, int DHTSensorType, String strTemp = "temperature1", String strHumid = "humidity1", bool In_C = false, byte filterConstant = 100);
			
			//destructor
			virtual ~PS_TemperatureHumidity_AM2320();
