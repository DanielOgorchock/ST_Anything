...
namespace st
{
	class IS_Contact: public InterruptSensor
	{
		...
		public:
			...
			IS_Contact(const char *name, byte pin, bool iState, bool internalPullup = false, long numReqCounts = 0); //(defaults to NOT using internal pullup resistors, and required counts = 0)
