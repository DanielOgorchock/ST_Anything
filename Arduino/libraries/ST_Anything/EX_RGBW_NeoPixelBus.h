...
//
//******************************************************************************************
#ifndef ST_EX_RGBW_NeoPixelBus
#define ST_EX_RGBW_NeoPixelBus
...
namespace st
{
	class EX_RGBW_NeoPixelBus: public Executor
	{
		private:
			...
			NeoPixelBus<NeoGrbwFeature, Neo800KbpsMethod> m_nStrip;		
	public:
			//constructor - called in your sketch's global variable declaration section
			EX_RGBW_NeoPixelBus(const __FlashStringHelper *name, uint16_t pixelCount, uint8_t pinRGB);
			
			//destructor
			virtual ~EX_RGBW_NeoPixelBus();
