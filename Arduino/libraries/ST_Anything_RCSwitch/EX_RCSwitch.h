...
namespace st
{
	class EX_RCSwitch: public Executor
	{
		...
		public:
			...
			EX_RCSwitch(const String &name, byte transmitterPin, unsigned long onCode, unsigned int onLength, unsigned long offCode, unsigned int offLength, bool startingState = LOW);
