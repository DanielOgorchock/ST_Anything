...
//public
	//constructor
	EX_RCSwitch::EX_RCSwitch(const char *name, byte transmitterPin, unsigned long onCode, unsigned int onLength, unsigned long offCode, unsigned int offLength, bool startingState) :
		Executor(name),
