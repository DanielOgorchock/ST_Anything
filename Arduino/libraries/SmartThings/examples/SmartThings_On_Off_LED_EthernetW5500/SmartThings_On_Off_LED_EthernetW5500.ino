...
/// @file
/// @brief
///   Arduino SmartThings Ethernet W5500 On/Off with LED Example 
///
///   Revised by Dan Ogorchock on 2017-02-10 to work with new "SmartThings v2.0" Library
///
///   Notes: Arduino communicates with both the W5500 and SD card using the SPI bus 
///          (through the ICSP header). This is on digital pins 10, 11, 12, and 13 
///          on the Uno and pins 50, 51, and 52 on the Mega. On both boards, pin 10 
///          is used to select the W5500 and pin 4 for the SD card. These pins cannot 
///          be used for general I/O. On the Mega, the hardware SS pin, 53, is not used 
///          to select either the W5500 or the SD card, but it must be kept as an output 
...
//******************************************************************************************
//W5500 Ethernet Shield Information  CHANGE THIS INFORMATION ACCORDINGLY FOR YOUR NETWORK!
//****************************************************************************************** 
...
//Create a SmartThings Ethernet W5500 object
st::SmartThingsEthernetW5500 smartthing(mac, ip, gateway, subnet, dnsserver, serverPort, hubIp, hubPort, messageCallout);
